  ...
  public: {
    Tables: {
      ...
      cbac_audit_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "cbac_audit_log_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      genres: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "genres_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      import_created_records: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "import_created_records_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      invoice_history: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "invoice_history_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      invoice_items: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "v_top_products_by_revenue"
      ...
      order_import_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "order_import_history_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      product_genres: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "product_genres_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      role_change_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "role_change_history_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      supplier_labels: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "supplier_labels_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      supplier_payouts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "supplier_payouts_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      support_grants: {
        ...
        Relationships: [
          {
            foreignKeyName: "support_grants_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
    ...
    Views: {
      v_cbac_status: {
        ...
        Insert: {
          active_trials_count?: never
          capabilities?: Json | null
          capability_overrides?: Json | null
          expired_overrides_count?: never
          plan_code?: string | null
          plan_version?: string | null
        }
        Update: {
